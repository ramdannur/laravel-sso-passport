              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-star" style="width:30px"><a href="{{ route('mail-star', ['inbox', $value->id]) }}"><i class="fa {{ $value->is_star=='1'?'fa-star':'fa-star-o' }} text-warning"></i></a></td>
                    <td class="mailbox-name"><a href="{{ route('mail-inbox-detail', $value->id) }}">{{ $value->from }}</a></td>
