...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)('.js-faq').click(function () {
    (0, _jquery2.default)(this).children('.list-answer').slideToggle(300);
  ...
  (0, _jquery2.default)('#edu-list').on('down.zf.accordion', function () {
    var $videoRowActive = (0, _jquery2.default)('.accordion-item.is-active');
    var $videoLink = $videoRowActive.find('.js-edu-video').attr('data-video-src');
    // $videoRowActive.find('iframe').attr('src', $videoLink);
    var $video = '<video src="' + $videoLink + '" controls></video>';
    $videoRowActive.find('.js-edu-video').append($video);
  });

  (0, _jquery2.default)('#edu-list').on('up.zf.accordion', function () {
    (0, _jquery2.default)('.js-edu-video').empty();
  });

  function imageUpload(fileInput, imageTarget) {
    (0, _jquery2.default)(fileInput).change(function (event) {
      if (this.files && this.files[0]) {
        var reader = new FileReader();
        reader.onload = function (e) {
          (0, _jquery2.default)(imageTarget).attr('src', e.target.result);
        };
  ...
  imageUpload('#file-upload', '#image-upload');
});
